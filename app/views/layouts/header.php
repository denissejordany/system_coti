...
$rol = $_SESSION['usuario']['rol'] ?? null;  // 1 = admin, 2 = cliente
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <title><?= isset($page_title) ? $page_title : 'Sistema' ?></title>
...
<a href="<?= BASE_URL ?>cliente/ver"
   ...
   Ver cotizaciones
            ...
            <a href="<?= BASE_URL ?>login/logout" class="logout">Cerrar sesión</a>
        </nav>
    </div>
</header>
